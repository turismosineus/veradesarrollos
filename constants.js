// Constantes de la aplicación (unidades, estados de órdenes, categorías de gasto)
export const UNITS = ['u','m','m²','m³','kg','ton','litros','bolsas','ml','gl'];
export const OSTATUS = ['pendiente','aprobada','entregada','pagada'];
export const OL = {pendiente:'Pendiente',aprobada:'Aprobada',entregada:'Entregada',pagada:'Pagada'};
